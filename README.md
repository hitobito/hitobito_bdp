...
* **▲Bundesebene**
  ...
  * **▲Landesverband**
    ...
    * _Kassenprüfer*in: []_
    * _Landesmitarbeiter*in: []_
    * _Landesmitgliederverwalter*in: 2FA [:layer_and_below_full, :contact_data, :assign_restricted_fee_kinds]_
    * _Landeswahlobmensch: []_
    * _Materialwart*in: []_
    ...
    * **Arbeitsbereiche**
      * **Ausbildung**
        ...
        * _AK Leiter*in: [:group_and_below_read, :contact_data]_
        * _AK Mitarbeiter*in: [:group_and_below_read]_
        * _Landesbeauftragte*r: [:layer_and_below_read, :contact_data]_
      * **Erwachsenenarbeit**
        * _AK Freie*r Mitarbeiter*in: []_
        * _AK Leiter*in: [:group_and_below_read, :contact_data]_
        * _AK Mitarbeiter*in: [:group_and_below_read]_
    ...
    * **▲Bezirk**
      ...
      * **▲Stamm**
        ...
        * _Erfasser*in Führungszeugnis: 2FA [:layer_and_below_read, :group_and_below_efz]_
        * _Ersatz-Landesdelegierte*r: []_
        * _Heimwart*in: []_
        * _Juleica-Inhaber*in: []_
        * _Kassenprüfer*in: []_
        * _Landesdelegierte*r: []_
        * _Materialwart*in: []_
    ...
    * **Landesgeschäftsstelle**
      ...
      * _Landesgeschäftsführer*in: 2FA [:layer_and_below_full, :contact_data, :finance]_
    * **Landesversammlung¹**
      * _Protokollführer*in: []_
      * _Techniker*in: []_
      * _Versammlungsleiter*in: []_
    * **Landesvorstand¹**
      ...
      * _Landesschatzmeister*in: 2FA [:layer_and_below_read, :contact_data, :finance, :assign_restricted_fee_kinds]_
      * _Landesvorsitzende*r: 2FA [:layer_and_below_read, :contact_data]_
      * _Stv. Landesschatzmeister*in: 2FA [:layer_and_below_read, :contact_data, :finance, :assign_restricted_fee_kinds]_
      * _Stv. Landesvorsitzende*r: 2FA [:layer_and_below_read, :contact_data]_
  * **Ombudsrat¹**
    * _Mitglied: []_
  * **Projekte**
    * **Projekt**
