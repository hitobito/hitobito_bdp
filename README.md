...
* **▲Bundesebene**  --  `Bundesebene`
    ...
    * **▲Landesverband**  --  `Landesverband`
        ...
        * **Landesgeschäftsstelle**  --  `Landesgeschaeftsstelle`
        * **Landesversammlung¹**  --  `Landesversammlung`
...
---  
Output of rake app:hitobito:groups  
🛈 use rake app:hitobito:groups:update_readme to update the README.md
<!-- groups:end -->
...
* **▲Bundesebene**  --  `Bundesebene`
  ...
  * **▲Landesverband**  --  `Landesverband`
    ...
    * _Landesmitarbeiter*in: []  --  `Group::Landesverband::Landesmitarbeiter`_
    * _Landesmitgliederverwalter*in: 2FA [:layer_and_below_full, :contact_data, :assign_restricted_fee_kinds]  --  `Group::Landesverband::Landesmitgliederverwaltung`_
    * _Landeswahlobmensch: []  --  `Group::Landesverband::Landeswahlobmensch`_
    ...
    * **Arbeitsbereiche**  --  `LandArbeitsbereiche`
      * **Ausbildung**  --  `LandAusbildung`
        ...
        * _Landesbeauftragte*r: [:layer_and_below_read, :contact_data]  --  `Group::LandArbeitsbereich::Beauftragt`_
      * **Erwachsenenarbeit**  --  `LandErwachsenenarbeit`
        * _AK Freie*r Mitarbeiter*in: []  --  `Group::LandArbeitsbereich::AKFreierMitarbeiter`_
        * _AK Leiter*in: [:group_and_below_read, :contact_data]  --  `Group::LandArbeitsbereich::AKLeitung`_
        * _AK Mitarbeiter*in: [:group_and_below_read]  --  `Group::LandArbeitsbereich::AKMitarbeiter`_
    ...
    * **▲Bezirk**  --  `Bezirk`
      ...
      * **▲Stamm**  --  `Stamm`
        ...
        * _Ersatz-Landesdelegierte*r: []  --  `Group::Stamm::LandesdelegiertErsatz`_
        ...
        * _Landesdelegierte*r: []  --  `Group::Stamm::Landesdelegiert`_
    ...
    * **Landesgeschäftsstelle**  --  `Landesgeschaeftsstelle`
      ...
      * _Landesgeschäftsführer*in: 2FA [:layer_and_below_full, :contact_data, :finance]  --  `Group::Landesgeschaeftsstelle::Landesgeschaeftsfuehrung`_
    * **Landesversammlung¹**  --  `Landesversammlung`
    ...
    * **Landesvorstand¹**  --  `Landesvorstand`
      ...
      * _Landesschatzmeister*in: 2FA [:layer_and_below_read, :contact_data, :finance, :assign_restricted_fee_kinds]  --  `Group::Landesvorstand::Landesschatzmeister`_
      * _Landesvorsitzende*r: 2FA [:layer_and_below_read, :contact_data]  --  `Group::Landesvorstand::Landesvorsitz`_
      * _Stv. Landesschatzmeister*in: 2FA [:layer_and_below_read, :contact_data, :finance, :assign_restricted_fee_kinds]  --  `Group::Landesvorstand::LandesschatzmeisterStv`_
      * _Stv. Landesvorsitzende*r: 2FA [:layer_and_below_read, :contact_data]  --  `Group::Landesvorstand::LandesvorsitzStv`_
  * **Ombudsrat¹**  --  `Ombudsrat`
